...
const lstFormality = [
  { name: 'Thế chấp', value: 'Thế chấp' },
  { name: 'Không thế chấp', value: 'Không thế chấp' },
]
...
const lstCollateral = [
  { name: 'Thẻ tiết kiệm', value: 'Thẻ tiết kiệm' },
  { name: 'Thẻ tiết kiệm - 2', value: 'Thẻ tiết kiệm - 2' },
]
      ...
      <Grid item sm={6} xs={12}>
        ...
        <div className={Style.textFieldWrapper}>
          <CustomSelect
            ...
            options={lstFormality}
            onChange={(value) => {
              handleForm(value, 'formality')
            }}
          />
        </div>
      </Grid>
